...
export const FileUpload = ({
  ...
  // Convert string accept to object for react-dropzone if needed
  // This is a naive conversion, but works for simple cases like "image/*"
  const dropzoneAccept = accept ? { [accept]: [] } : undefined;
