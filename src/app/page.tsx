      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto">
            The professional drag-and-drop form builder for modern teams. Gather
            insights, automate workflows, and integrate with your favorite
            tools.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <PricingCard
              title="Starter"
              price="0"
              features={["10 Forms", "100 Submissions/mo", "Basic Fields"]}
            />
            <PricingCard
              title="Pro"
              price="29"
...
const PricingCard = ({
  ...
  <Card
    className={`p-8 flex flex-col relative ${featured ? "border-zinc-900 ring-1 ring-zinc-900" : ""}`}
  >
    {featured && (
      <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-zinc-900 text-white px-3 py-1 rounded-full text-xs font-bold">
        Most Popular
      </span>
    )}
    <div className="mb-8">
